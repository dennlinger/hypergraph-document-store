"""
Attempt at a first template script to evaluate runtimes for the explicit model in Neo4j.
"""
...
if __name__ == "__main__":
    print("Evaluation for Explicit Model")
    fn = "./entities.json"
    with open(fn) as f:
        data = json.load(f)
    ...
    for window in [0, 1, 2, 5]:
        ...
        subprocess.run(["ln", "-s", "/data/daumiller/hypergraphs-bp/explicit_model/graph_{}.db".format(window),

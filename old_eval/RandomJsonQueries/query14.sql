-- 2016-07-19
-- Query to extract the most frequently co-occurring terms together with "2016-07-19"
...
FROM entity_hyperedges AS eh2,
     (SELECT eh.edge_id, eh.term_id
      ...
      WHERE t.term_id = eh.term_id AND t.term_text ILIKE '2016-07-19') AS special,
     terms AS t2
